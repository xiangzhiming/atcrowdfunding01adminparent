...
<script type="text/javascript">
    $(function () {
        ...
        $("#treeDemo").on("click",".editBtn",function () {
            ...
            // 回显radio可以这样理解：被选中的radio的value属性可以组成一个数组，然后再用这个数组设置回radio，就能够吧对应的值选中
        ...
        $("#treeDemo").on("click",".removeBtn",function () {
            ...
            $("#removeNodeSpan").html("【<i class='" + currentNode.icon + "'>" + currentNode.name+"】");

            return false;

        });
        
        // 给添加字节点的模态框中的保存按钮添加点击事件
               ...
               type: "post",
                ...
                success: function (resp) {
                    ...
                    if (result == "SUCCESS") {
                        ...
                        // 重新刷新树形结构,注意：要在确认服务器端完成保存操作后再刷新
